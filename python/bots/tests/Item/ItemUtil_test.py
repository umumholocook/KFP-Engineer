...
class TestItemUtil():
    ...
    def test_createItem_failed_itemExist(self):
        ItemUtil.createItem(guild_id=1, item_name="hello", itemtype=1, buff_type=1, buff_value=-1, buff_round=2)
        result = ItemUtil.createItem(guild_id=1, item_name="hello", itemtype=1, buff_type=1, buff_value=-1, buff_round=2)
        assert result == -1
    ...
    def test_deleteItems_success(self):
        ...
        ItemUtil.createItem(guild_id=1, item_name="heap", itemtype=4, buff_type=2, buff_value=10, buff_round=3, level_required=0, price=1)
        ItemUtil.createItem(guild_id=1, item_name="hot", itemtype=4, buff_type=2, buff_value=10, buff_round=3, level_required=0, price=1)
