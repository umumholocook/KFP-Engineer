...
class RockPaperScissorsUtil():
    ...
    TOO_FAST = [
        ...
        "這麼沒耐心吵著急著要找我的，也就只有你了吧…給我等{:.2f}秒啊笨蛋",
        "已經迫不及待了嗎...？還要再等{:.2f}秒喔？",
        "這麼快就想我了？再{:.2f}秒就陪你玩吧",
        "啊，稍等{:.2f}秒好嗎？我忙著磨刺妮的刀呢",
        "再給我{:.2f}秒？等大總管烤完章魚，就分你一口吧？",
    ]
    TIE_DIALOG = [
        "居然一樣耶, 說不定我們很有默契哦",
        "居然一樣耶, 說不定我們很合得來哦",
    ...
    WIN_DIALOG = [
        ...
        "我又贏了啊？真是無趣。",
        "我贏了？哈，一點都不意外的結果呢。",
        "像你這樣的敗者，就該臣服於本大總管之下…..不能拒絕喔？",
        "不服氣嗎？那也是沒辦法的事情。",
        "吶吶，你該不會哭鼻子了吧？那也沒辦法改變我勝利的事實。",
    ...
    LOSE_DIALOG = [
        ...
        "呃... ~~今天天氣不錯啊~~",
        "恩... 我一定是哪裡出錯了...",
        "我輸了…？快…快看！天上有章魚！什麼轉移注意力…我怎麼可能耍賴！",
        # regret
        "咕... 可惡...居然輸了...",
        "咕... 可惡...居然輸了... ~~那我先脫~~",
        "咕... 可惡...我居然輸了...",
        ...
        "…如果能讓你開心，偶爾認輸也不是什麼大不了的事情吧…",
        "大總管怎麼可能輸…只是為了讓你開心而已…笨蛋", 
        "這…這樣的放水是唯有你才有的待遇！好好感謝本大總管吧，笨蛋！",
        ...
        "大...大總管才沒有輸呢...!"
        "就知道吃雞腿！會變月巴的啦！笨蛋！",
        "唔…想要雞腿我就會給你嗎….？好啦趕快閉嘴拿去！！！",
        "切…！反正我也不缺雞腿，勉為其難施捨給你吧！",
        "雞腿這種東西，本大總管怎麼可能稀罕！",
        "哼….偶然的失手罷了,別太囂張啊你!!!",
        "嗚….欺負bot的壞人…..我這就去告訴Azu….!!",
        "切….!!就算輸了我還是有Azu姐姐…!!",
        "嗚啊啊啊怎麼可以欺負大總管...我要告訴雀月姊姊！",
    ]
